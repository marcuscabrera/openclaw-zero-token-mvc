...
/**
 * Login automático no Kimi: consistente com Claude/Doubao, usa o Chrome do sistema OpenClaw.
 * Não depende do Chromium bundled do Playwright (não requer npx playwright install)
 */
